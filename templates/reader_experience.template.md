...
Theo dõi khi relevant:

- `Không X. Mà Y.`;
- short negation paragraphs;
- `Đúng / Nhưng / Vậy / Cho nên` argument rhythm;
- hypothesis-loop;
- aphorism/conclusion sentence;
- notebook/list ending;
...
- Last grief/joy/shame/fear/attachment beat:
- Last object/memory meaning shift:
...
- Calibration locked: yes/no
- Active samples this chapter/batch:
- Engines represented:
