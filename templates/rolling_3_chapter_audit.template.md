# Rolling 3-Chapter Audit Template
...
| Chapter | Opening shape | First tension source | Similarity risk |
|---:|---|---|---|

- 3 openings có cùng cách vào cảnh?:
- Required correction for current chapter:
...
- Q&A meeting lặp?:
- A hỏi → B trả lời → MC kết luận lặp?:
- mọi nhân vật đều nói sạch, đủ ý, ít cắt lời?:
