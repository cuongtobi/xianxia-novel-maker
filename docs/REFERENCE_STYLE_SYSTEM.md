...
- POV distance;
- cách xử lý cultivation/combat/exposition;
...
Style Director adapt theo premise và Character DNA, không dùng profile như few-shot prose.

## 4. Weakness filter

Không học exposition/recap dài, cú pháp dịch cứng, stock gesture, connector lặp, slow transition không có giá trị hoặc aphorism thiếu scene support.

## 5. Project-owned calibration

Chỉ dùng final/user-approved samples của chính story. Sample nên đa dạng theo scene type; không cần Narrative Engine quota. Học rhythm/diction/POV texture, không copy câu/rhetorical frame.

## 6. Style QC

Trong `combined_qc_report.md`, phần **Style** kiểm:

- drift-away khỏi house style;
- overfit/imitation;
- weakness leakage;
- AI-like repeated cadence/rhetorical tics;
- dialogue sameness;
- exposition/recap/cadence problems.

Reference Style không tạo thêm report, gate hoặc controller riêng.
